...
2. **VP看板**（经营与人才培养视角 · 谁要辅导？资源给谁？）：**本部定位**（公司内排名/百分位/引领者-中位-落后者，集成在Hero区）、二级+三级树状热力对比（**含主管效能标签列**：优秀标杆/稳健/需辅导）、**经理人效能象限**（本事业部三级部门负责人的四象限散点图：横轴=得分偏离公司均值，纵轴=人员间标准差×10，圆圈大小=团队人数，象限=明星经理/偏心眼经理/统一型弱经理/危险经理，附象限解读表）、**员工类型分布**（下辖所有三级部门100%堆叠条形图：消极/中立/激发/高效四分类，按消极占比降序）、**本部特质诊断**（与公司差异最大3题=VP自身风格影响）、**跨部门共性识别**（多部门同低=事业部级问题）、逐题得分卡（对比公司）
